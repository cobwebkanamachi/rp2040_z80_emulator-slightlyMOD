  ...
  while (RUN == true) {
    ...
    switch (OC) {  //Switch based on OPCode
      ...
      default:  //NOP or anything not recognised
        zprintf("Unknown OP-Code %.2X at %.4X\n\r", OC, PC - 1);
        break;
    }
...
void CPU_ED(void) {
  ...
  switch (V8a) {
    ...
    case 0xB1:              //** CPIR **
      ...
      break;
    default:
      zprintf("Unknown OP-Code ED %.2X at %.4X\n\r", V8a, PC - 1);
      break;
  }
}
...
void CPU_CB(void) {
  ...
  switch (V8a) {
    ...
    case 0x7F:  //BIT 7, A
      ...
      break;
    default:
      zprintf("Unknown OP-Code CB %.2X at %.4X\n\r", V8a, PC - 1);
      break;
  }
}
...
void CPU_DD(void) {
  ...
  switch (V8a) {
    ...
    case 0xe5:  //** Push IX **
      ...
      break;
    default:
      zprintf("Unknown OP-Code DD %.2X at %.4X\n\r", V8a, PC - 1);
      break;
  }
}
...
void CPU_FD(void) {
  ...
  switch (V8a) {
    ...
    case 0xe5:  //** Push IY **
      ...
      break;
    default:
      zprintf("Unknown OP-Code FD %.2X at %.4X\n\r", V8a, PC - 1);
      break;
  }
}
...
void portOut(uint8_t p, uint8_t v) {
  ...
  switch (p) {
    ...
    case DCMD:
      ...
      if (sdfound == true) {
        switch (v) {
          ...
          default: zprintf("Unknown Disk Command: 0x%.2X\n\r", v); break;
        }
      }
      break;
    case DPARM: break;
    ...
    default:  //Just print data
      //zprintf("Port Out: %.2X  Val: %.2X PC: %.4X\n\r", p, v, PC);
      break;
  }
}
...
uint8_t portIn(uint8_t p) {
  switch (p) {
    ...
    case DCMD:
      break;
    default:
      zprintf("Port In: %.2X  Val: %.2X PC: %.4X\n\r", p, pIn[p], PC);
      break;
  }
